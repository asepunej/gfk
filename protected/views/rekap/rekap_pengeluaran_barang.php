...
<script type="text/javascript">
    ...
    function detailpengeluaran01(id_bidang_penerima)
    {
        var url = '/index.php?r=Rekap/RekapPengeluaranBarang01';
        var form = $('<form action="' + url + '" method="POST" + target=_blank>' +
            '<input type="hidden" name="id_barang"  value="' + $('#id_barang').val() + '" />' +
            '<input type="hidden" name="id_bidang_penerima" value="' + id_bidang_penerima + '" />' +
...
<table border=1  bordercolor=#96EBFD cellspacing=1 cellpadding=1 width=100%>
    ...
    <tr rowspan="2" align="center" height='40px' bgcolor="#C4E9fA">
        ...
        <th align='center' width=70%>Penerima Barang</th>
    ...
    $total=$total+$value["volume"];
        ...
        <td valign="top" align="left"><?php echo $value["nama_skpd"]?></td>
         <td valign="top" align="right">
                ...
                echo CHtml::label('<u>'.number_format( $value["volume"].'</u>', 0 , "" , '.' ),'',
                    array(
                        'title' => 'Detail',
//                  'style' => 'width:20px',
                        "onClick"=>"detailpengeluaran01('$value[id_bidang_penerima]')"
                    ));
                ?>        </td>
          </tr>
...
<?php echo CHtml::hiddenField('txttgl_mulai',$tgl_mulai);  ?>
<?php echo CHtml::hiddenField('txttgl_akhir',$tgl_akhir);  ?>
