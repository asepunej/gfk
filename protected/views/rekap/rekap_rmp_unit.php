...
<script type="text/javascript">
    ...
    function proses()    {
           var url = '/index.php?r=Rekap/RekapRmpUnit';
            var form = $('<form action="' + url + '" method="POST">' +
...
<div class="panel-heading">
    ...
    <b>REKAP MUTASI DINAS KESEHATAN DAN PUSKESMAS </b>
</div>
<br>
...
<table border=1  bordercolor=#96EBFD cellspacing=1 cellpadding=1 width=1000>
    ...
    <tr rowspan="2" align="center" height='40px' bgcolor="#C4E9fA">
      ...
      <th width=200 rowspan="3" align='center'>Unit kerja</th>
