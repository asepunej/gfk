...
<table border=1  bordercolor=#96EBFD cellspacing=1 cellpadding=1 width=1000>
    ...
    $sum_saldoawal=$sum_saldoawal+round($value["saldoawal_jumlah"],2);
    $sum_bertambah=$sum_bertambah+round($value["penerimaan_jumlah"],2);
    $sum_berkurang=$sum_berkurang+round($value["pengeluaran_jumlah"],2);
    $saldoakhir_jumlah=round($value["saldoawal_jumlah"],2)+round($value["penerimaan_jumlah"],2)-round($value["pengeluaran_jumlah"],2);
    ...
    <tr height="30" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
        ...
        <td valign="top" align="right"> <?php echo number_format(round( $value["saldoawal_jumlah"],2) , 2 , ',' , '.' )?>

        <td valign="top" align="right" bgcolor="#adff2f" > <?php echo number_format( $value["penerimaan_volume"] , 0 , "" , '.' )?></td>
        <td valign="top" align="right"> <?php echo number_format(round( $value["penerimaan_jumlah"],2) , 2 , ',' , '.' )?>

         <td valign="top" align="right" bgcolor="#adff2f"> <?php echo number_format( $value["pengeluaran_volume"] , 0 , "" , '.' )?></td>
        <td valign="top" align="right"> <?php echo number_format(round( $value["pengeluaran_jumlah"],2) , 2 , ',' , '.' )?>

        <td valign="top" align="right" bgcolor="#adff2f"> <?php echo number_format( $value["saldoakhir_volume"] , 0 , "" , '.' )?></td>
        <td valign="top" align="right"> <?php echo number_format(round( $saldoakhir_jumlah,2) , 2 , ',' , '.' )?> </td>
