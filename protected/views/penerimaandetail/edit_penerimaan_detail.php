...
<div align="left">
    <table >
        ...
        <tr>
            <td valign="top" width=120><?php echo "Nama Barangt"?></td>
            <td valign="top" width=20><?php echo ""?>:</td>
            <td valign="top">
                <?php echo CHtml::textField('txtnama_barang','['.$kd_barang.'] '. $nama_barang.' ('. $satuan.')',
...
<!--                <input name="txtjumlah" id="m_oJmlStr" value="--><?php //echo $harga_satuan;?><!--" onblur="runCurr()" onkeyup="runCurr()" style="TEXT-ALIGN: right" maxlength="15" type="text">-->
                ...
                <?php echo CHtml::textField('txtjumlah', $harga_satuan,
        ...
        <tr>
            ...
            <td valign="top">  <?php
                $this->widget('zii.widgets.jui.CJuiDatePicker',array(
                    'name'=>'txttgl_expired',
                    'value'=>Yii::app()->dateFormatter->format("dd MMMM yyy",$expired),
                    'options'=>array(
                        'showAnim'=>'fold',
                    ),
                    'htmlOptions'=>array(
    ...
    <?php echo CHtml::hiddenField('id_penerimaan_detail',$id_penerimaan_detail);  ?>
