...
<script type="text/javascript">
       ...
       function insertdata()
    {
        var url = '/index.php?r=Bidang/InsertBidang';
        var form = $('<form action="' + url + '" method="POST">' +
            '<input type="hidden" name="id_skpd" value="' + $('#ddlskpd').val() + '" />' +
            '</form>');
        $('body').append(form);
        $(form).submit();
    }

       function editdata(id_bidang)
       {
           var url = '/index.php?r=Bidang/EditBidang';
           var form = $('<form action="' + url + '" method="POST">' +
    ...
    function deletedata(id_bidang,bidang)
    {
...
<div class="panel-heading">
    ...
    <b>DAFTAR UNIT PUSKESMAS</b>
</div>

<br>
<table border=0 cellspacing=0 cellpadding=0 width=600>
    <tr>
        <td valign="top" width=100><?php echo "Puskesmas"?></td>
...
<table border=1  bordercolor=#96EBFD cellspacing=1 cellpadding=1 width=800>
    ...
    <tr rowspan="2" align="center" height='40px' bgcolor="#C4E9fA">
            ...
            <th align='center' width=700>Unit / Poli Puskesmas</th>
