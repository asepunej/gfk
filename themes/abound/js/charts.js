...
$(document).ready(function() {
	...
	$(function () {
		var data = [
		    { label: "FKIP",  data: 38, color: "#88bbc8"},
		    { label: "FTP.",  data: 23, color: "#ed7a53"},
		    { label: "FH",  data: 15, color: "#9FC569"},
		    { label: "FISIP",  data: 9, color: "#bbdce3"},
		    { label: "FE",  data: 7, color: "#9a3b1b"},
		    { label: "FMIPA",  data: 5, color: "#5a8022"},
		    { label: "FK",  data: 3, color: "#2c7282"}
		];
