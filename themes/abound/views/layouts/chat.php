...
//                    echo "Nama=".$nama;
                    ...
                    $this->widget('YiiChatWidget',array(
                       ...
                       'model'=>new ChatHandler(), // the class handler using database
                        'data'=>$id_user,                 // data passed to the handler
...
<!--                            </div>-->
<!--                        <td width="50%"><a href="files/PanduanRaker2014.docx">DISETUJUI</a></td>-->
<!---->
<!---->
<!--                        </td>-->
<!--                    </tr>-->
...
<!--                            </div>-->
<!--                        </td>-->
<!--                        <td><a href="files/FormatTOR&RAB.pdf" target="_blank">DIPERBAIKI</a></td>-->
<!---->
<!--                    </tr>-->
<!--                    <tr>-->
<!--                        <td>-->
...
<!--                            </div>-->
<!--                        </td>-->
<!--                        <td><a href="files/akun.pdf" target="_blank">BELUM DIREVIEW</a></td>-->
<!---->
<!--                    </tr>-->
<!--                    <tr>-->
<!---->
